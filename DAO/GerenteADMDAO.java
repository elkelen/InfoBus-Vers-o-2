...
public class GerenteADMDAO {

    // --- INSERIR GERENTE ADM ---
    public void inserir(GerenteADM g) {
        ...
        String sqlGerenteADM = "INSERT INTO gerenteADM (idGerenteADM) VALUES (?)";
        ...
        try (Connection conn = DB.getConnection()) {
            ...
            // Inserir gerenteADM
            try (PreparedStatement ps3 = conn.prepareStatement(sqlGerenteADM)) {
    ...
    // --- LISTAR TODOS OS GERENTES ADM ---
    public List<GerenteADM> listarTodos() {
        List<GerenteADM> lista = new ArrayList<>();
        String sql = "SELECT u.idUsuario, u.nome, u.cpf, u.email, u.telefone, u.senha, " +
                     ...
                     "JOIN gerenteADM g ON f.idFuncionario = g.idGerenteADM";
    ...
    // --- ATUALIZAR GERENTE ADM ---
    public void atualizar(GerenteADM g) {
    ...
    public void deletar(int id) {
        String sqlGerenteADM = "DELETE FROM gerenteADM WHERE idGerenteADM=?";
        ...
        try (Connection conn = DB.getConnection()) {
            ...
            try (PreparedStatement ps = conn.prepareStatement(sqlGerenteADM)) {
                ps.setInt(1, id);
                ps.executeUpdate();
            }
    ...
    // --- BUSCAR POR ID ---
    public GerenteADM buscarPorId(int id) {
        String sql = "SELECT u.idUsuario, u.nome, u.cpf, u.email, u.telefone, u.senha, " +
                     "f.matricula, f.cargo, f.salario, f.statusPagamento " +
                     "FROM usuario u " +
                     "JOIN funcionario f ON u.idUsuario = f.idFuncionario " +
